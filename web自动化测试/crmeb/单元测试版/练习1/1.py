...
class kaida(unittest.TestCase):
    ...
    def mubiao1(self):
        ...
        time.sleep(2)
        self.driver.find_element(By.XPATH,'//*[@id="app"]/div/div[2]/div[2]/div/div[2]/div[基础_1]/div/div/div[基础_1]/div[基础_1]/div[2]/table/tbody/tr[基础_1]/td[基础_1]/div/label/span/input').click()

        self.text = self.driver.find_element(By.XPATH,'/html/body/div[基础_1]/div/div[2]/div[2]/div/div[2]/div[基础_1]/div/div/div[基础_1]/div[基础_1]/div[2]/table/tbody/tr[基础_1]/td[3]/div/span').text
