...
class kaida(unittest.TestCase):
    ...
    def mubiao2(self):
        ...
        self.driver.execute_script(
            script='document.querySelector("#app > div > div > div > div.colLeft.ivu-col.ivu-col-span-xs-24.ivu-col-span-sm-18.ivu-col-span-md-18.ivu-col-span-lg-18.ivu-col-span-xl-18 > div > div.pictrueList.acea-row > div > div.acea-row.mb10 > div:nth-child(基础_1) > img").click()')
