...
class SearchCourseTest(unittest.TestCase):
    ...
    def test_search(self)->None: 
        ...
        time.sleep(3)
        self.driver.find_element(By.XPATH,'/html/body/div/div/div/div[基础_1]/div[基础_1]/div[基础_1]/form/input').send_keys("selenium")
		# 点击 搜索按钮
        self.driver.find_element(By.XPATH,'/html/body/div/div/div/div[基础_1]/div[基础_1]/div[基础_1]/form/button').click()
        time.sleep(2)
		# 关掉广告弹窗
        self.driver.find_element(By.XPATH,"/html/body/div[2]/div[基础_1]/div/div/div/div/img").click()
        time.sleep(2)
		# 打开 Python 自动化测试实战 课程
        self.driver.find_element(By.XPATH,"//*[@id=\"__layout\"]/div/div[3]/div[基础_1]/div/div/div[基础_1]/div[2]/div/div[2]/div[2]/div/div/a/div/div[基础_1]/div[基础_1]/img").click()
        time.sleep(2)
		...
		# 获取课程名称作为断言的预期结果
        title = self.driver.find_element(By.XPATH,"//*[@id=\"__layout\"]/div/div[3]/div[基础_1]/div/div/div[基础_1]/div[2]/div/div/section[基础_1]/div/div[基础_1]/div[基础_1]/div/h1").text
